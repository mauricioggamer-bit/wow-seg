export const classic = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const outland = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const wotlk = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const cata = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const mop = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const draenor = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
...
export const legion = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const bfa = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const shadowlands = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const dragonflight = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const tww = `<svg viewBox="0 0 320 220" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
export const midnight = `<svg viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg" style="color:#6b2fa0">
  <defs>
    <radialGradient id="bg_mid" cx="50%" cy="50%" r="70%">
      <stop offset="0%" stop-color="#0e081a"/>
  ...
  <path d="M400,80 Q550,100 650,180 Q720,280 680,400 Q600,500 480,520 Q350,530 250,480 Q150,400 160,280 Q180,160 300,100 Z" fill="#6b2fa0" opacity="0.12" stroke="#6b2fa0" stroke-width="2" filter="url(#glow_mid)"/>
  <path d="M400,80 Q550,100 650,180 Q720,280 680,400 Q600,500 480,520 Q350,530 250,480 Q150,400 160,280 Q180,160 300,100 Z" fill="none" stroke="#6b2fa0" stroke-width="0.5" opacity="0.3"/>
  <g fill="#6b2fa0" opacity="0.8" font-family="Cinzel,serif" font-size="12" text-anchor="middle">
  ...
  <g transform="translate(720, 55)">
    <circle r="32" fill="none" stroke="#6b2fa0" stroke-width="2" opacity="0.4"/>
    <circle r="26" fill="#6b2fa0" opacity="0.15"/>
    <text x="0" y="8" text-anchor="middle" font-size="20" font-family="Cinzel,serif" font-weight="700" fill="#6b2fa0">M</text>
  </g>
  <text x="720" y="110" text-anchor="middle" font-size="14" font-family="Cinzel,serif" font-weight="700" fill="#6b2fa0" opacity="0.8">Midnight</text>
</svg>`

const mapa_svgs: Record<string, string> = {
  classic,
  outland,
  wotlk,
  cata,
