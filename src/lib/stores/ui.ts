...
const VALID_VIEWS: ViewType[] = ['warband', 'tareas', 'tasks', 'personajes', 'mapa', 'fantasia', 'profesion', 'keybinds', 'leveling', 'warband-manager', 'estrategia', 'opie', 'account-tasks', 'tokens']
