...
<style>
  .fantasia-panel { height:calc(100vh - 100px); margin-top:6px; border:1px solid var(--border-subtle); border-radius:var(--r-md); overflow:hidden; background:var(--bg-base); }
  .fantasia-editor { display:flex; flex-direction:column; overflow:hidden; }
